...
def emit(tm) -> None:
    ...
    # --- #602  ==Reasearch============   [display 794]
    t = tm.add_trigger('==Reasearch============', description_stid=0)

    # --- #603  Research Cartography   [display 795]
    ...
    # --- #604  Research Walls   [display 796]
    ...
    # --- #638  =KILLSP1================   [display 830]
    t = tm.add_trigger('=KILLSP1================', description_stid=0)

    # --- #639  50 kills   [display 831]
    ...
    # --- #726  ====Defeated===   [display 918]
    t = tm.add_trigger('====Defeated===', description_stid=0)

    # --- #727  remove (p1)   [display 919]
