...
def apply(ctx) -> None:
    ...
    p.initial_player_view_y = 46
    p.disabled_techs = [51]
    p.disabled_buildings = [562, 584, 70, 82, 621, 109, 72, 50, 276, 68, 104, 45, 598, 199]
    ...
    p.diplomacy = [DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY]
    # --- P2
    p = pm.players[2]
    p.starting_age = StartingAge.FEUDAL_AGE
    p.lock_civ = False
    ...
    p.disabled_units = [83, 1810, 83, 1810, 1126, 1128, 530, 1800, 1802, 8, 1968, 1970, 1129, 1131, 763, 765, 1007, 1009, 692, 694, 876, 878, 554, 25, 1949, 1951, 1263, 36, 1001, 1003, 827, 829, 128, 1904, 1907, 2150, 1980, 1962, 2151, 1704, 1706, 40, 553, 1790, 1792, 73, 559, 771, 773, 1655, 1657, 1120, 1122, 239, 558, 279, 542, 1735, 1737, 866, 868, 1747, 1749, 1911, 1959, 1961, 1013, 1015, 725, 726, 2107, 2108, 41, 759, 41, 759, 555, 761, 555, 761, 869, 871, 232, 534, 2101, 2102, 46, 557, 879, 881, 1228, 1230, 1231, 1233, 1225, 1254, 1225, 1254, 1225, 1254, 1225, 1254, 1227, 1255, 1227, 1255, 1227, 1255, 1227, 1255, 1741, 1743, 281, 531, 1234, 1236, 1920, 1922, 282, 556, 280, 11, 561, 1701, 1703, 1803, 1805, 1709, 550, 588, 1908, 1910, 1759, 1761, 1123, 1125, 1811, 291, 560, 1658, 1660, 1658, 1660, 1658, 1660, 1658, 1660, 1659, 1661, 1659, 1661, 1659, 1661, 1659, 1661, 1016, 1018, 2104, 2105, 755, 886, 755, 886, 757, 887, 757, 887, 1105, 1942, 1923, 440]
    p.diplomacy = [DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY, DiplomacyState.ENEMY]
    ...
    msg.scouts = '...::: CBA HERO Three Kingdoms FFA by Big_Ytri :::...\r\rCBA Royal / Greece / China DLC adapted by Big_Ytri.\rCBA creator: Tenchy\rHero editor: Milhão\rConverted to Definitive Edition by Alian713.\r\rNew map functions (votekick, counters...) by Big_Ytri (tx RoyalHack)'
