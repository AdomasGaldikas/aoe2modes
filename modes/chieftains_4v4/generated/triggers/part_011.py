...
def emit(tm) -> None:
    ...
    t.new_effect.display_instructions(
        ...
        display_time=30,
        play_sound=1,
        message=' ..:: CBA HERO 2026  by Big_Ytri ::..\r       __Chieftains Version___ \rNew Features:\r- New Chieftains CIVS Added:\rMapuche, Muiscas, Tupís\r- K/D Counters Added!\r-Vote Kick Players Added!\r-New DLC CIVS Added!\r-Read Instructions to see ChangeLog!',
    ...
    # --- #2965  VoteKickP1-P3-P4   [display 2965]
    ...
    # --- #2966  VoteKickP1-P3-P2   [display 2966]
    ...
    # --- #2967  VoteKickP2-P1-P3   [display 2967]
    ...
    # --- #2968  VoteKickP2-P1-P4   [display 2968]
    ...
    # --- #2969  VoteKickP2-P3-P4   [display 2969]
    ...
    # --- #2970  VoteKickP3-P1-P2   [display 2970]
    ...
    # --- #2971  VoteKickP3-P1-P4   [display 2971]
    ...
    # --- #2972  VoteKickP3-P2-P4   [display 2972]
    ...
    # --- #2973  VoteKickP4-P1-P3   [display 2973]
    ...
    # --- #2974  VoteKickP4-P1-P2   [display 2974]
    ...
    # --- #2975  VoteKickP4-P3-P2   [display 2975]
    ...
    # --- #2976  VoteKickP5-P6-P7   [display 2976]
    ...
    # --- #2977  VoteKickP5-P6-P8   [display 2977]
    ...
    # --- #2978  VoteKickP5-P7-P8   [display 2978]
    ...
    # --- #2979  VoteKickP6-P5-P7   [display 2979]
    ...
    # --- #2980  VoteKickP6-P5-P8   [display 2980]
    ...
    # --- #2981  VoteKickP6-P7-P8   [display 2981]
    ...
    # --- #2982  VoteKickP7-P5-P6   [display 2982]
    ...
    # --- #2983  VoteKickP7-P5-P8   [display 2983]
    ...
    # --- #2984  VoteKickP7-P6-P8   [display 2984]
    ...
    # --- #2985  VoteKickP8-P5-P6   [display 2985]
    ...
    # --- #2986  VoteKickP8-P5-P7   [display 2986]
    ...
    # --- #2987  VoteKickP8-P6-P7   [display 2987]
    ...
    t.new_effect.activate_trigger(trigger_id=2998)
    t.new_effect.activate_trigger(trigger_id=817)
    t.new_effect.activate_trigger(trigger_id=453)
    t.new_effect.activate_trigger(trigger_id=302)

    # --- #2998  Hippeus P1   [display 3086]
    ...
    # --- #2999  Espartano P2   [display 3079]
    ...
    t.new_effect.activate_trigger(trigger_id=3000)
    t.new_effect.activate_trigger(trigger_id=818)
    t.new_effect.activate_trigger(trigger_id=490)
    t.new_effect.activate_trigger(trigger_id=363)
