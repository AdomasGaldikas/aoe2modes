...
def apply(ctx) -> None:
    ...
    # --- Messages tab
    msg.instructions = "ChangeLog 2026 Chieftains by Big_Ytri v1.1:\r\r- Spain nerfed to NON Elite Units, now applies!\r- Bengalies all units all 'Ranged'\r- Added NEW DLC Chieftains CIVs:\rMapuche\rMuiscas\rTupis\r- Added Kills and Deaths Counter!\r\r- Added Vote Kick for kick any type of players (Lag / Feed / Toxic / etc.): Delete outpost to vote for kick colour player. Two votes needed to kick.\r\r- Added New DLC CIVS:\r  1. Greece CIVS:\r     1.1. Spartans: Ready\r     1.2. Achaemenits: Ready\r     1.3. Athenians: Ready\r  2. China CIVS:\r     2.1. Shu: Ready\r     2.2. Wei: Ready\r     2.3. Wu: Ready\r     2.4. Kitans: Ready\r     2.5. Yurchen: Ready\r\r- New Balance Changes:\r   1. Turks: Now 750 For Imp. 50 Units and NO Elites.\r   2. Persian: Now 40 Units and NO Elites.\r   3. Lot of balance changes (See Hints)\r\r- Bug Fixes:\r\r1. Great Khan correct stats from beginning \r2. Some civs spawn bug pop\r3. Dravinians spawn solved for Teal\r4. Khamers spawn solved for Purple\r"
    ...
    msg.scouts = '...::: CBA HERO Three Kingdoms 4v4 by Big_Ytri :::...\r\rCBA Royal / Greece / China DLC adapted by Big_Ytri.\rCBA creator: Tenchy\rHero editor: Milhão\rConverted to Definitive Edition by Alian713.\r\rNew map functions (votekick, counters...) by Big_Ytri (tx RoyalHack)'
