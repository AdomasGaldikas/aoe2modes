...
- [`docs/ascendants-development.md`](docs/ascendants-development.md) — the sole v1.0.3 historical baseline, v1.0.16 candidate, verification layers, and safe issue-fixing loop.
