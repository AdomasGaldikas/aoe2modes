...
- [`docs/ascendants-data-tables.md`](docs/ascendants-data-tables.md) — the civilization tables, hero milestones, the full 0–120 variable registry, and runbooks for changing them.
...
- [`docs/ascendants-development.md`](docs/ascendants-development.md) — the sole v1.0.3 historical baseline, v1.0.17 candidate, verification layers, and safe issue-fixing loop.
