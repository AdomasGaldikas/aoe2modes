...
| [`evolution_alpha`](modes/evolution_alpha/) | decompiled + patches | **CBA Hero: Ascendants v1.0.7 candidate** — built from the sole v1.0.3 baseline, with five working Sheep controls, shared army/hero route selection, one-shot army launches, color-aware compact lobbies, buildable milestone shores, unobstructed hero spawns, resignation cleanup, six hero tiers, protected team routes, center rewards, vote-kicks, live K/D/R, and a compact warning-free trigger graph. 2291 triggers, 1076 units. |
...
- [`docs/ascendants-development.md`](docs/ascendants-development.md) — the sole v1.0.3 baseline, v1.0.7 candidate, verification layers, and safe issue-fixing loop.
