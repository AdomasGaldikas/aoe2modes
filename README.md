...
- [`docs/ascendants-data-tables.md`](docs/ascendants-data-tables.md) — the civilization tables, hero milestones, the full 0–136 variable registry, and runbooks for changing them.
