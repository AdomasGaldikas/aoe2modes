...
| [`evolution_alpha`](modes/evolution_alpha/) | code-defined | **CBA Hero: Ascendants v1.0.15 candidate** — evolved from the sole v1.0.3 historical baseline, with engine-resolved shuffled-lobby ownership, Castle-bound army spawns, independent six-level Sheep and Penguin controls confined to separate tracks with snowy HOLD/OFF pads, side-wall removal and an active 200-warning/220-wall wipe that preserve the front and University barriers, one-shot army/hero/builder orders, buildable milestone shores, unobstructed hero spawns, resignation cleanup, mirrored anti-Trebuchet protection, six hero tiers, protected team routes, center rewards, vote-kicks, and live K/D/R. No obsolete corner clutter, blocking Castle Hay, or hidden Goth Palisade bonus. 3,647 triggers, 956 units; warning-free strict audit and 119 passing repository tests. |
...
- [`docs/ascendants-development.md`](docs/ascendants-development.md) — the sole v1.0.3 historical baseline, v1.0.15 candidate, verification layers, and safe issue-fixing loop.
